...
!(function (t, e) {
  ...
  var a = function (t) {
    ...
    w = function (t, e) {
      if (!y(t)) return t;
      var i, n;
      if (e && "function" == typeof (i = t.toString) && !y((n = i.call(t))))
        return n;
      if ("function" == typeof (i = t.valueOf) && !y((n = i.call(t)))) return n;
      if (!e && "function" == typeof (i = t.toString) && !y((n = i.call(t))))
        return n;
    ...
    A = {
      f: l
        ...
        : function (t, e) {
            ...
            if (x(t, e)) return d(!u.f.call(t, e), t[e]);
          },
    },
    I = function (t) {
  ...
  var D,
    ...
    L = N.inspectSource,
    H = s.WeakMap,
    M = "function" == typeof H && /native code/.test(L(H)),
    U = o(function (t) {
  ...
  var it,
    ...
    at = o(function (t) {
      ...
      (t.exports = function (t, e, o, a) {
        var r,
          ...
          h = !!a && !!a.noTargetGet;
        "function" == typeof o &&
          ("string" != typeof e || x(o, "name") || R(o, "name", e),
          (r = i(o)).source ||
            (r.source = n.join("string" == typeof e ? e : ""))),
          t !== s
            ? (l ? !h && t[e] && (c = !0) : delete t[e],
              c ? (t[e] = o) : R(t, e, o))
            : c
            ? (t[e] = o)
            : j(e, o);
    ...
    dt = Math.min,
    ft = function (t) {
      return t > 0 ? dt(ut(t), 9007199254740991) : 0;
    },
    pt = Math.max,
    gt = Math.min,
    vt = function (t, e) {
      var i = ut(t);
      return i < 0 ? pt(i + e, 0) : gt(i, e);
    },
    bt = function (t) {
      return function (e, i, n) {
        ...
        if (t && i != i) {
          ...
          for (; s > r; r++)
            if ((t || r in a) && a[r] === i) return t || r || 0;
        return !t && -1;
      };
    },
    ...
    wt = function (t, e) {
      var i,
        ...
        o = 0,
        a = [];
      for (i in n) !x(Y, i) && x(n, i) && a.push(i);
      for (; e.length > o; ) x(n, (i = e[o++])) && (~yt(a, i) || a.push(i));
      return a;
    },
    St = [
      "constructor",
    ...
    Tt = function (t, e) {
      for (var i = Ct(e), n = E.f, o = A.f, a = 0; a < i.length; a++) {
        var s = i[a];
        x(t, s) || n(t, s, o(e, s));
      }
    },
    ...
    At = function (t, e) {
      var i = $t[It(t)];
      return i == Rt || (i != Et && ("function" == typeof e ? r(e) : !!e));
    },
    ...
    Nt = function (t, e) {
      var i,
        ...
        c = t.global,
        h = t.stat;
      if ((i = c ? s : h ? s[l] || j(l, {}) : (s[l] || {}).prototype))
        for (n in e) {
          if (
            ((a = e[n]),
            (o = t.noTargetGet ? (r = _t(i, n)) && r.value : i[n]),
            !jt(c ? n : l + (h ? "." : "#") + n, t.forced) && void 0 !== o)
          ) {
            if (typeof a == typeof o) continue;
            Tt(a, o);
          }
          (t.sham || (o && o.sham)) && R(a, "sham", !0), at(i, n, a, t);
        }
    },
    Ft =
      Array.isArray ||
    ...
    Lt = Bt && !Symbol.sham && "symbol" == typeof Symbol.iterator,
    Ht = U("wks"),
    Mt = s.Symbol,
    Ut = Lt ? Mt : (Mt && Mt.withoutSetter) || W,
    zt = function (t) {
      return (
        x(Ht, t) ||
          (Bt && x(Mt, t) ? (Ht[t] = Mt[t]) : (Ht[t] = Ut("Symbol." + t))),
        Ht[t]
      );
    },
    qt = zt("species"),
    Wt = function (t, e) {
      ...
      return (
        Ft(t) &&
          ...
          (i !== Array && !Ft(i.prototype))
            ? y(i) && null === (i = i[qt]) && (i = void 0)
            : (i = void 0)),
        new (void 0 === i ? Array : i)(0 === e ? 0 : e)
      );
    },
    Gt = lt("navigator", "userAgent") || "",
    Kt = s.process,
    Yt = Kt && Kt.versions,
    Xt = Yt && Yt.v8;
  Xt
    ? (nt = (it = Xt.split("."))[0] + it[1])
    : Gt &&
      (!(it = Gt.match(/Edge\/(\d+)/)) || it[1] >= 74) &&
      (it = Gt.match(/Chrome\/(\d+)/)) &&
      (nt = it[1]);
  var Jt = nt && +nt,
    Qt = zt("species"),
    Zt = function (t) {
    ...
    te = zt("isConcatSpreadable"),
    ee = 9007199254740991,
    ie = "Maximum allowed index exceeded",
    ne =
      Jt >= 51 ||
      !r(function () {
        var t = [];
        return (t[te] = !1), t.concat()[0] !== t;
      }),
    oe = Zt("concat"),
    ae = function (t) {
      if (!y(t)) return !1;
  ...
  Nt(
    { target: "Array", proto: !0, forced: !ne || !oe },
    {
      concat: function (t) {
        var e,
          i,
        ...
        for (e = -1, n = arguments.length; e < n; e++)
          if (ae((a = -1 === e ? s : arguments[e]))) {
            if (l + (o = ft(a.length)) > ee) throw TypeError(ie);
            for (i = 0; i < o; i++, l++) i in a && Vt(r, l, a[i]);
          } else {
            if (l >= ee) throw TypeError(ie);
            Vt(r, l++, a);
          }
        return (r.length = l), r;
      },
  ...
  var se = function (t) {
      ...
      return function (l, c, h, u) {
        for (
          var d,
            ...
            y = 0,
            w = u || Wt,
            S = e ? w(l, m) : i || s ? w(l, 0) : void 0;
          m > y;
          y++
        )
          if ((r || y in g) && ((f = b((d = g[y]), y, p)), t))
            if (e) S[y] = f;
            else if (f)
              switch (t) {
                case 3:
    ...
    fe = function (t, e) {
      ...
      return (ue[t] =
        ...
        !r(function () {
          if (n && !l) return !0;
          var t = { length: -1 };
          n ? he(t, 1, { enumerable: !0, get: de }) : (t[1] = 1),
            i.call(t, o, a);
        }));
    },
    pe = ce.filter,
    ...
    ve = fe("filter");
  Nt(
    { target: "Array", proto: !0, forced: !ge || !ve },
    {
      filter: function (t) {
  ...
  var be,
    ...
    ye = l
      ...
      : function (t, e) {
          I(t);
          for (var i, n = me(e), o = n.length, a = 0; o > a; )
            E.f(t, (i = n[a++]), e[i]);
          return t;
        },
    we = lt("document", "documentElement"),
    Se = K("IE_PROTO"),
    xe = function () {},
    ke = function (t) {
    ...
    Oe = function () {
      ...
      Oe = be
        ...
        : (((e = C("iframe")).style.display = "none"),
          ...
          t.close(),
          t.F);
      for (var i = St.length; i--; ) delete Oe.prototype[St[i]];
      return Oe();
    };
  Y[Se] = !0;
  var Ce =
    ...
    Te = zt("unscopables"),
    Pe = Array.prototype;
  null == Pe[Te] && E.f(Pe, Te, { configurable: !0, value: Ce(null) });
  var Ae = function (t) {
      Pe[Te][t] = !0;
    },
    Ie = ce.find,
  ...
  $e in [] &&
    ...
    Nt(
      { target: "Array", proto: !0, forced: Ee || !Re },
      {
        find: function (t) {
  ...
  _e in [] &&
    ...
    Nt(
      { target: "Array", proto: !0, forced: Ne || !Fe },
      {
  ...
  Nt({ target: "Array", proto: !0, forced: [].forEach != He }, { forEach: He });
  var Me = mt.includes,
    Ue = fe("indexOf", { ACCESSORS: !0, 1: 0 });
  Nt(
    { target: "Array", proto: !0, forced: !Ue },
    {
      includes: function (t) {
  ...
  var ze = mt.indexOf,
    qe = [].indexOf,
    We = !!qe && 1 / [1].indexOf(1, -0) < 0,
    Ge = De("indexOf"),
    Ke = fe("indexOf", { ACCESSORS: !0, 1: 0 });
  Nt(
    { target: "Array", proto: !0, forced: We || !Ge || !Ke },
    {
      indexOf: function (t) {
        return We
          ? qe.apply(this, arguments) || 0
          : ze(this, t, arguments.length > 1 ? arguments[1] : void 0);
      },
    }
  );
  var Ye,
  ...
  [].keys &&
    ("next" in (Je = [].keys())
      ? (Xe = ei(ei(Je))) !== Object.prototype && (Ye = Xe)
      : (ni = !0)),
    null == Ye && (Ye = {}),
    x(Ye, ii) ||
      R(Ye, ii, function () {
  ...
  var oi = { IteratorPrototype: Ye, BUGGY_SAFARI_ITERATORS: ni },
    ai = E.f,
    si = zt("toStringTag"),
    ri = function (t, e, i) {
      t &&
        !x((t = i ? t : t.prototype), si) &&
        ai(t, si, { configurable: !0, value: e });
    },
    li = oi.IteratorPrototype,
    ci =
      ...
      ("__proto__" in {}
        ...
        : void 0),
    hi = oi.IteratorPrototype,
    ui = oi.BUGGY_SAFARI_ITERATORS,
    di = zt("iterator"),
    fi = "keys",
    pi = "values",
    gi = "entries",
    ...
    mi = ot.set,
    yi = ot.getterFor(bi),
    wi = (function (t, e, i, n, o, a, s) {
      !(function (t, e, i) {
        var n = e + " Iterator";
        (t.prototype = Ce(li, { next: d(1, i) })), ri(t, n, !1);
      })(i, e, n);
      var r,
        l,
        c,
      ...
      if (
        (b &&
          ...
          hi !== Object.prototype &&
            r.next &&
            (ei(r) !== hi &&
              (ci ? ci(r, hi) : "function" != typeof r[di] && R(r, di, vi)),
            ri(r, u, !0))),
        o == pi &&
          g &&
          g.name !== pi &&
        ...
        if (((l = { values: h(pi), keys: a ? v : h(fi), entries: h(gi) }), s))
          for (c in l) (ui || f || !(c in p)) && at(p, c, l[c]);
        else Nt({ target: e, proto: !0, forced: ui || f }, l);
      return l;
    })(
      Array,
      "Array",
      function (t, e) {
        mi(this, { type: bi, target: m(t), index: 0, kind: e });
      },
      function () {
        var t = yi(this),
          e = t.target,
  ...
  Ae("keys"), Ae("values"), Ae("entries");
  var Si = [].join,
    xi = v != Object,
    ki = De("join", ",");
  Nt(
    { target: "Array", proto: !0, forced: xi || !ki },
    {
      join: function (t) {
        return Si.call(m(this), void 0 === t ? "," : t);
      },
    }
  );
  var Oi = ce.map,
  ...
  var Pi = [].reverse,
    Ai = [1, 2];
  Nt(
    { target: "Array", proto: !0, forced: String(Ai) === String(Ai.reverse()) },
    {
      reverse: function () {
        return Ft(this) && (this.length = this.length), Pi.call(this);
      },
    }
  );
  var Ii = Zt("slice"),
    $i = fe("slice", { ACCESSORS: !0, 0: 0, 1: 2 }),
    Ei = zt("species"),
    Ri = [].slice,
    ji = Math.max;
  Nt(
    { target: "Array", proto: !0, forced: !Ii || !$i },
    {
      slice: function (t, e) {
        var i,
          n,
        ...
        if (
          ...
          (i !== Array && !Ft(i.prototype))
            ? y(i) && null === (i = i[Ei]) && (i = void 0)
            : (i = void 0),
          i === Array || void 0 === i)
        )
          return Ri.call(a, r, l);
        for (
          n = new (void 0 === i ? Array : i)(ji(l - r, 0)), o = 0;
          r < l;
          r++, o++
        )
          r in a && Vt(n, o, a[r]);
  ...
  var _i = [],
    ...
    Vi = De("sort");
  Nt(
    { target: "Array", proto: !0, forced: Fi || !Di || !Vi },
    {
      sort: function (t) {
        return void 0 === t ? Ni.call(Dt(this)) : Ni.call(Dt(this), se(t));
      },
    }
  );
  var Bi = Zt("splice"),
    Li = fe("splice", { ACCESSORS: !0, 0: 0, 1: 2 }),
    Hi = Math.max,
    Mi = Math.min,
    Ui = 9007199254740991,
    zi = "Maximum allowed length exceeded";
  Nt(
    { target: "Array", proto: !0, forced: !Bi || !Li },
    {
      splice: function (t, e) {
        var i,
          n,
        ...
        if (
          (0 === u
            ...
            : 1 === u
            ? ((i = 0), (n = c - h))
            : ((i = u - 2), (n = Mi(Hi(ut(e), 0), c - h))),
          c + i - n > Ui)
        )
          throw TypeError(zi);
        for (o = Wt(l, n), a = 0; a < n; a++)
          (s = h + a) in l && Vt(o, a, l[s]);
        if (((o.length = n), i < n)) {
          for (a = h; a < c - n; a++)
            (r = a + i), (s = a + n) in l ? (l[r] = l[s]) : delete l[r];
          for (a = c; a > c - n + i; a--) delete l[a - 1];
        } else if (i > n)
          for (a = c - n; a > h; a--)
            (r = a + i - 1), (s = a + n - 1) in l ? (l[r] = l[s]) : delete l[r];
  ...
  var qi = function (t, e, i) {
    ...
    Xi = function (t) {
      return function (e) {
        var i = String(b(e));
        return (
          1 & t && (i = i.replace(Ki, "")), 2 & t && (i = i.replace(Yi, "")), i
        );
      };
    },
    Ji = { start: Xi(1), end: Xi(2), trim: Xi(3) },
    Qi = kt.f,
    Zi = A.f,
    tn = E.f,
    en = Ji.trim,
    ...
    rn = function (t) {
      ...
      if ("string" == typeof c && c.length > 2)
        if (43 === (e = (c = en(c)).charCodeAt(0)) || 45 === e) {
          ...
          for (s = (a = c.slice(2)).length, r = 0; r < s; r++)
            if ((l = a.charCodeAt(r)) < 48 || l > o) return NaN;
          return parseInt(a, n);
        }
      return +c;
    };
  if (jt(nn, !on(" 0o1") || !on("0b1") || on("+0x1"))) {
    for (
      var ln,
        cn = function (t) {
          var e = arguments.length < 1 ? 0 : t,
            i = this;
          return i instanceof cn &&
            (sn
              ? r(function () {
                  an.valueOf.call(i);
                })
      ...
      x(on, (ln = hn[un])) && !x(cn, ln) && tn(cn, ln, Zi(on, ln));
    (cn.prototype = an), (an.constructor = cn), at(s, nn, cn);
  }
    ...
    pn =
      ...
      r(function () {
            ...
            dn(
              ...
              dn(
                fn({}, "a", {
                  enumerable: !0,
                  get: function () {
                    fn(this, "b", { value: 3, enumerable: !1 });
                  },
                }),
                { b: 2 }
              )
        ...
        return (
          ...
          7 != dn({}, t)[i] || me(dn({}, e)).join("") != n
        );
      })
        ? function (t, e) {
            for (
              var i = Dt(t), n = arguments.length, o = 1, a = Ot.f, s = u.f;
              n > o;
              ...
              for (
                var r,
                  c = v(arguments[o++]),
                  h = a ? me(c).concat(a(c)) : me(c),
                  d = h.length,
                  f = 0;
                d > f;

              )
                (r = h[f++]), (l && !s.call(c, r)) || (i[r] = c[r]);
            return i;
          }
        : dn;
  Nt(
  ...
  var gn = u.f,
    vn = function (t) {
      return function (e) {
        for (var i, n = m(e), o = me(n), a = o.length, s = 0, r = []; a > s; )
          (i = o[s++]), (l && !gn.call(n, i)) || r.push(t ? [i, n[i]] : n[i]);
        return r;
      };
    },
    bn = { entries: vn(!0), values: vn(!1) }.entries;
  Nt(
  ...
  yn || at(Object.prototype, "toString", kn, { unsafe: !0 });
  var On = Ji.trim,
    Cn = s.parseFloat,
    Tn =
      1 / Cn(Wi + "-0") != -1 / 0
        ...
        : Cn;
  Nt({ global: !0, forced: parseFloat != Tn }, { parseFloat: Tn });
  var Pn = Ji.trim,
    An = s.parseInt,
    In = /^[+-]?0[Xx]/,
    $n =
      8 !== An(Wi + "08") || 22 !== An(Wi + "0x16")
        ? function (t, e) {
            var i = Pn(String(t));
            return An(i, e >>> 0 || (In.test(i) ? 16 : 10));
          }
        : An;
  Nt({ global: !0, forced: parseInt != $n }, { parseInt: $n });
  var En = zt("match"),
    Rn = function (t) {
      var e;
      return y(t) && (void 0 !== (e = t[En]) ? !!e : "RegExp" == p(t));
    },
    jn = function () {
      var t = I(this),
        e = "";
  ...
  if (
    ...
    jt(
      ...
      !qn ||
        ...
        r(function () {
          return (
            (zn[Ln] = !1), Hn(Un) != Un || Hn(zn) == zn || "/a/i" != Hn(Un, "i")
          );
        })
    )
  ) {
    for (
      var Gn = function (t, e) {
          var i,
            n = this instanceof Gn,
            o = Rn(t),
            a = void 0 === e;
          if (!n && o && t.constructor === Gn && a) return t;
          qn
            ? o && !a && (t = t.source)
            : t instanceof Gn && (a && (e = jn.call(t)), (t = t.source)),
            Wn && (i = !!e && e.indexOf("y") > -1) && (e = e.replace(/y/g, ""));
          var s = qi(qn ? new Hn(t, e) : Hn(t, e), n ? this : Mn, Gn);
          return Wn && i && Bn(s, { sticky: i }), s;
        },
        Kn = function (t) {
          (t in Gn) ||
            Dn(Gn, t, {
      ...
      Kn(Yn[Xn++]);
    (Mn.constructor = Gn), (Gn.prototype = Mn), at(s, "RegExp", Gn);
  }
  !(function (t) {
    var e = lt(t),
      i = E.f;
  ...
  var Jn = RegExp.prototype.exec,
    ...
    to = (function () {
      var t = /a/,
        e = /b*/g;
      return (
        Jn.call(t, "a"), Jn.call(e, "a"), 0 !== t.lastIndex || 0 !== e.lastIndex
      );
    })(),
    eo = Nn.UNSUPPORTED_Y || Nn.BROKEN_CARET,
    io = void 0 !== /()??/.exec("")[1];
  (to || io || eo) &&
    (Zn = function (t) {
      var e,
      ...
      return (
        ...
        s
          ? n
            ...
            : (a.lastIndex = 0)
          : to && n && (a.lastIndex = a.global ? n.index + n[0].length : e),
        io &&
          n &&
          n.length > 1 &&
  ...
  var no = Zn;
  Nt({ target: "RegExp", proto: !0, forced: /./.exec !== no }, { exec: no });
  var oo = "toString",
    ao = RegExp.prototype,
    so = ao.toString,
    ro = r(function () {
      return "/a/b" != so.call({ source: "a", flags: "b" });
    }),
    lo = so.name != oo;
  (ro || lo) &&
    at(
      ...
      function () {
        ...
        return (
          ...
          "/" +
          String(
            void 0 === i && t instanceof RegExp && !("flags" in ao)
              ? jn.call(t)
              : i
          )
        );
  ...
  var fo = zt("species"),
      ...
      if (
        ...
        var l = /./[o],
          c = i(
            ...
            {
              REPLACE_KEEPS_$0: go,
              REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: bo,
            }
          ),
          h = c[0],
          u = c[1];
        at(String.prototype, t, h),
          at(
            RegExp.prototype,
            o,
            2 == e
    ...
    So = { codeAt: wo(!1), charAt: wo(!0) }.charAt,
    xo = function (t, e, i) {
      return e + (i ? So(t, e).length : 1);
    },
    ko = function (t, e) {
      var i = t.exec;
    ...
    return [
      ...
      function (t, n) {
        ...
        for (var p = []; ; ) {
          ...
          if (null === g) break;
          if ((p.push(g), !d)) break;
          "" === String(g[0]) && (c.lastIndex = xo(h, ft(c.lastIndex), f));
        }
        for (var v, b = "", m = 0, y = 0; y < p.length; y++) {
          g = p[y];
          for (
            var w = String(g[0]),
              S = Oo(Co(ut(g.index), h.length), 0),
              x = [],
              k = 1;
            k < g.length;
            k++
          )
            x.push(void 0 === (v = g[k]) ? v : String(v));
          var O = g.groups;
          if (u) {
            var C = [w].concat(x, S, h);
            void 0 !== O && C.push(O);
            var T = String(n.apply(void 0, C));
          } else T = r(w, h, S, x, O, n);
          S >= m && ((b += h.slice(m, S) + T), (m = S + w.length));
        }
        return b + h.slice(m);
      },
    ];
    function r(t, i, n, o, a, s) {
      var r = n + t.length,
        l = o.length,
        c = Ao;
      return (
        void 0 !== a && ((a = Dt(a)), (c = Po)),
        e.call(s, c, function (e, s) {
          var c;
          switch (s.charAt(0)) {
            case "$":
              return "$";
    ...
    return [
      ...
      function (t) {
        ...
        var o = I(t),
          a = String(this),
          s = o.lastIndex;
        Io(s, 0) || (o.lastIndex = 0);
        var r = ko(o, a);
        return (
          Io(o.lastIndex, s) || (o.lastIndex = s), null === r ? -1 : r.index
        );
      },
    ];
  });
          ...
          "".split(/.?/).length
            ? function (t, i) {
                ...
                for (
                  ...
                  !(
                    (s = u.lastIndex) > h &&
                    (l.push(n.slice(h, a.index)),
                    a.length > 1 &&
                      a.index < n.length &&
                      Eo.apply(l, a.slice(1)),
                    (r = a[0].length),
                    (h = s),
                    l.length >= o)
                  );
          ...
          function (t, o) {
            ...
            var s = I(t),
              ...
              l = (function (t, e) {
                var i,
                  n = I(t).constructor;
                return void 0 === n || null == (i = I(n)[$o]) ? e : se(i);
              })(s, RegExp),
              c = s.unicode,
              h =
                (s.ignoreCase ? "i" : "") +
                ...
                (s.unicode ? "u" : "") +
                (_o ? "y" : "g"),
              u = new l(_o ? s : "^(?:" + s.source + ")", h),
              d = void 0 === o ? jo : o >>> 0;
            if (0 === d) return [];
            if (0 === r.length) return null === ko(u, r) ? [r] : [];
            for (var f = 0, p = 0, g = []; p < r.length; ) {
              u.lastIndex = _o ? p : 0;
              var v,
                b = ko(u, _o ? r : r.slice(p));
              if (
                null === b ||
                (v = Ro(ft(u.lastIndex + (_o ? 0 : p)), r.length)) === f
              )
                p = xo(r, p, c);
              else {
  ...
  function Xo(t, e, i) {
    return e && Yo(t.prototype, e), i && Yo(t, i), t;
  }
  function Jo(t, e) {
    return (
      (function (t) {
  ...
  var ia = 4;
  try {
    var na = i.default.fn.dropdown.Constructor.VERSION;
    void 0 !== na && (ia = parseInt(na, 10));
  } catch (t) {}
  try {
    var oa = bootstrap.Tooltip.VERSION;
    void 0 !== oa && (ia = parseInt(oa, 10));
  } catch (t) {}
  var aa = {
      3: {
    ...
    sa = {
      ...
      buttonsPrefix: aa.classes.buttonsPrefix,
      buttonsClass: aa.classes.buttons,
      icons: aa.icons,
      iconSize: void 0,
      iconsPrefix: aa.iconsPrefix,
    ...
    ra = {
      ...
      formatShowingRows: function (t, e, i, n) {
        return void 0 !== n && n > 0 && n > i
          ? "Mostrando "
              ...
              .concat(n, " total rows)")
          : "Mostrando ".concat(t, " a ").concat(e, " de ").concat(i, " filas");
      },
      ...
      formatDetailPagination: function (t) {
        return "Mostrando ".concat(t, " rows");
      },
  ...
  var ca = {
      ...
      LOCALES: { en: ra, "en-US": ra },
    },
    ha = r(function () {
      me(1);
    });
  Nt(
    { target: "Object", stat: !0, forced: ha },
    {
      keys: function (t) {
        return me(Dt(t));
      },
  ...
  var ua,
    ...
    pa = Math.min,
    ga = uo("endsWith"),
    va = !(ga || ((ua = da(String.prototype, "endsWith")), !ua || ua.writable));
  Nt(
    { target: "String", proto: !0, forced: !va && !ga },
    {
      endsWith: function (t) {
        var e = String(b(this));
        co(t);
        var i = arguments.length > 1 ? arguments[1] : void 0,
          n = ft(e.length),
          o = void 0 === i ? n : pa(ft(i), n),
          a = String(t);
        return fa ? fa.call(e, a, o) : e.slice(o - a.length, o) === a;
      },
    }
  );
  var ba = A.f,
    ...
    Sa =
      !wa &&
      !!(function () {
        var t = ba(String.prototype, "startsWith");
        return t && !t.writable;
      })();
  Nt(
    { target: "String", proto: !0, forced: !Sa && !wa },
    {
      startsWith: function (t) {
        var e = String(b(this));
        co(t);
        var i = ft(ya(arguments.length > 1 ? arguments[1] : void 0, e.length)),
          n = String(t);
        return ma ? ma.call(e, n, i) : e.slice(i, i + n.length) === n;
      },
    }
  );
  var xa = {
      getSearchInput: function (t) {
        return "string" == typeof t.options.searchSelector
          ? i.default(t.options.searchSelector)
          : t.$toolbar.find(".search input");
      },
      sprintf: function (t) {
        for (
        ...
        for (var r = 0; r < t.length; r++) {
          ...
          try {
            for (c.s(); !(l = c.n()).done; ) {
              ...
              (h.colspanIndex = f),
                1 === d
                  ? ((h.fieldIndex = f), void 0 === h.field && (h.field = f))
                  : (h.colspanGroup = h.colspan);
              for (var p = 0; p < u; p++)
                for (var g = 0; g < d; g++) n[r + p][f + g] = !0;
            }
          } catch (t) {
            c.e(t);
          } finally {
                ...
                if (r.colspanGroup > 1) {
                  for (
                    var l = 0,
                      ...
                      h = r.colspanIndex;
                    h < r.colspanIndex + r.colspanGroup;
                    h++
                  )
                    c(h);
                  (r.colspan = l), (r.visible = l > 0);
                }
              }
            } catch (t) {
              s.e(t);
      ...
      calculateObjectValue: function (t, e, i, n) {
        ...
        return null !== o && "object" === Go(o)
          ? o
          : "function" == typeof o
          ? o.apply(t, i || [])
          : !o &&
            "string" == typeof e &&
            this.sprintf.apply(this, [e].concat(Qo(i)))
          ? this.sprintf.apply(this, [e].concat(Qo(i)))
          : n;
      },
        ...
        return (
          e.each(function (e, s) {
            var r = i.default(s),
              l = {};
            (l._id = r.attr("id")),
              (l._class = r.attr("class")),
              (l._data = n.getRealDataAttr(r.data())),
              (l._style = r.attr("style")),
              r.find(">td,>th").each(function (o, s) {
                for (
                  var r = i.default(s),
                    c = +r.attr("colspan") || 1,
                    h = +r.attr("rowspan") || 1,
                ...
                var p = t[u].field;
                (l[p] = r.html().trim()),
                  (l["_".concat(p, "_id")] = r.attr("id")),
                  (l["_".concat(p, "_class")] = r.attr("class")),
                  (l["_".concat(p, "_rowspan")] = r.attr("rowspan")),
                  (l["_".concat(p, "_colspan")] = r.attr("colspan")),
                  (l["_".concat(p, "_title")] = r.attr("title")),
                  (l["_".concat(p, "_data")] = n.getRealDataAttr(r.data())),
                  (l["_".concat(p, "_style")] = r.attr("style"));
              }),
              o.push(l);
          }),
          o
      ...
      checkAutoMergeCells: function (t) {
        ...
        try {
          for (i.s(); !(e = i.n()).done; )
            for (
              var n = e.value, o = 0, a = Object.keys(n);
              o < a.length;
              o++
            ) {
              var s = a[o];
      ...
      deepCopy: function (t) {
        return void 0 === t
          ? t
          : i.default.extend(!0, Array.isArray(t) ? [] : {}, t);
      },
    },
    ka = (function () {
      function t(e) {
        ...
        Xo(t, [
          {
            ...
            value: function (t, e) {
              ...
              var i = this.initData(t, this.getNum(e)),
                ...
                s = this.checkChanges("bottom", i.bottomOffset),
                r = [];
              o && a
                ? (i.topOffset && r.push(this.getExtra("top", i.topOffset)),
                  r.push(n),
                  i.bottomOffset &&
                    r.push(this.getExtra("bottom", i.bottomOffset)),
                  (this.contentEl.innerHTML = r.join("")),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              return { topOffset: o, bottomOffset: a, rowsAbove: r, rows: s };
            },
          },
          {
            key: "checkChanges",
      ...
      return (
        Xo(t, [
          ...
          },
          {
            ...
            value: function () {
              var t = this.options;
              (this.constants = ca.CONSTANTS),
                (this.constants.theme = i.default.fn.bootstrapTable.theme),
              ...
              (this.constants.buttonsClass = [
                t.buttonsPrefix,
                e + t.buttonsClass,
                xa.sprintf("".concat(e, "%s"), t.iconSize),
              ]
                .join(" ")
                .trim()),
                (this.buttons = xa.calculateObjectValue(
                  this,
                  t.buttons,
                  [],
                  {}
                )),
                "object" !== Go(this.buttons) && (this.buttons = {}),
                "string" == typeof t.icons &&
                  (t.icons = xa.calculateObjectValue(null, t.icons));
            },
          },
          {
            key: "initLocale",
            value: function () {
              if (this.options.locale) {
                var t = i.default.fn.bootstrapTable.locales,
                  e = this.options.locale.split(/-|_/);
                (e[0] = e[0].toLowerCase()),
                  e[1] && (e[1] = e[1].toUpperCase()),
                  t[this.options.locale]
                    ? i.default.extend(this.options, t[this.options.locale])
                    : t[e.join("-")]
                    ? i.default.extend(this.options, t[e.join("-")])
                    : t[e[0]] && i.default.extend(this.options, t[e[0]]);
              }
            },
          },
          {
            ...
            value: function () {
              ...
              (this.$container = i.default(
                ...
                this.options.buttonsToolbar
                  ? (this.$toolbar = i
                      .default("body")
                      .find(this.options.buttonsToolbar))
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                ...
                this.$header.find("tr").each(function (t, o) {
                  var a = i.default(o),
                    s = [];
                  a.find("th").each(function (t, e) {
                    ...
                    n.push(s),
                    a.attr("class") && e._headerTrClasses.push(a.attr("class")),
                    a.attr("style") && e._headerTrStyles.push(a.attr("style"));
                }),
                Array.isArray(this.options.columns[0]) ||
                  (this.options.columns = [this.options.columns]),
                (this.options.columns = i.default.extend(
                  !0,
                  [],
                  n,
                ...
                xa.setFieldIndex(this.options.columns),
                this.options.columns.forEach(function (n, o) {
                  n.forEach(function (n, a) {
                    var s = i.default.extend({}, t.COLUMN_DEFAULTS, n);
                    void 0 !== s.fieldIndex &&
                      ((e.columns[s.fieldIndex] = s),
                      (e.fieldsColumnsIndex[s.field] = s.fieldIndex)),
                      (e.options.columns[o][a] = s);
                  });
                }),
                !this.options.data.length)
              ) {
                var o = xa.trToData(this.columns, this.$el.find(">tbody>tr"));
                o.length && ((this.options.data = o), (this.fromHtml = !0));
              }
              (this.options.pagination &&
                "server" !== this.options.sidePagination) ||
                (this.footerData = xa.trToData(
                  this.columns,
          ...
          },
          {
            ...
            value: function () {
              ...
              (this.header = {
                ...
                xa.updateFieldGroup(this.options.columns),
                this.options.columns.forEach(function (i, o) {
                  var a = [];
                  a.push(
                    "<tr"
                      .concat(
                        xa.sprintf(' class="%s"', t._headerTrClasses[o]),
                        " "
                      )
                      .concat(
                        xa.sprintf(' style="%s"', t._headerTrStyles[o]),
                        ">"
                      )
                  );
                  var s = "";
                  if (0 === o && xa.hasDetailViewIcon(t.options)) {
                    var r =
                      t.options.columns.length > 1
                        ? ' rowspan="'.concat(t.options.columns.length, '"')
                        : "";
                    s = '<th class="detail"'.concat(
                      r,
                      '>\n          <div class="fht-cell"></div>\n          </th>'
                    );
                  }
                  s && "right" !== t.options.detailViewAlign && a.push(s),
                    i.forEach(function (i, n) {
                      var s = xa.sprintf(' class="%s"', i.class),
                        r = i.widthUnit,
                        l = parseFloat(i.width),
                        c = xa.sprintf(
                          "text-align: %s; ",
                          i.halign ? i.halign : i.align
                        ),
                        h = xa.sprintf("text-align: %s; ", i.align),
                        u = xa.sprintf("vertical-align: %s; ", i.valign);
                      if (
                        ((u += xa.sprintf(
                          "width: %s; ",
                          (!i.checkbox && !i.radio) || l
                            ? l
                              ? l + r
                              : void 0
                            : i.showSelectTitle
                        ...
                        void 0 !== i.fieldIndex || i.visible)
                      ) {
                        var d = xa.calculateObjectValue(
                            null,
                            t.options.headerStyle,
                            [i]
                          ),
                          f = [],
                          p = "";
                        ...
                        if (
                          (d &&
                            ...
                            (p = xa.sprintf(
                              ' class="%s"',
                              i.class
                                ? [i.class, d.classes].join(" ")
                                : d.classes
                            )),
                          void 0 !== i.fieldIndex)
                        ) {
                          if (
                            ((t.header.fields[i.fieldIndex] = i.field),
                            (t.header.styles[i.fieldIndex] = h + u),
                            (t.header.classes[i.fieldIndex] = s),
                            (t.header.formatters[i.fieldIndex] = i.formatter),
                            (t.header.detailFormatters[i.fieldIndex] =
                              i.detailFormatter),
                            (t.header.events[i.fieldIndex] = i.events),
                            (t.header.sorters[i.fieldIndex] = i.sorter),
                            (t.header.sortNames[i.fieldIndex] = i.sortName),
                            (t.header.cellStyles[i.fieldIndex] = i.cellStyle),
                            (t.header.searchables[i.fieldIndex] = i.searchable),
                            !i.visible)
                          )
                            return;
                        ...
                        a.push(
                          "<th".concat(
                            xa.sprintf(' title="%s"', i.titleTooltip)
                          ),
                          i.checkbox || i.radio
                            ? xa.sprintf(
                                ' class="bs-checkbox %s"',
                            ...
                            : p || s,
                          xa.sprintf(' style="%s"', c + u + f.join("; ")),
                          xa.sprintf(' rowspan="%s"', i.rowspan),
                          xa.sprintf(' colspan="%s"', i.colspan),
                          xa.sprintf(' data-field="%s"', i.field),
                          ...
                          a.push(
                            xa.sprintf(
                              ...
                              t.options.sortable && i.sortable
                                ? "sortable both"
                                : ""
                            )
                          );
                        var w = t.options.escape
                            ? xa.escapeHTML(i.title)
                            : i.title,
                          S = w;
                        i.checkbox &&
                          ((w = ""),
                          ...
                          (t.header.stateField = i.field)),
                          i.radio &&
                            ((w = ""), (t.header.stateField = i.field)),
                          !w && i.showSelectTitle && (w += S),
                          a.push(w),
                          a.push("</div>"),
                    ...
                    s && "right" === t.options.detailViewAlign && a.push(s),
                    a.push("</tr>"),
                    a.length > 3 && n.push(a.join(""));
                }),
                this.$header.html(n.join("")),
                this.$header.find("th[data-field]").each(function (t, n) {
                ...
                this.$header
                  ...
                  .on("keypress", function (e) {
                    t.options.sortable &&
                      i.default(e.currentTarget).data().sortable &&
                      13 === (e.keyCode || e.which) &&
                      t.onSort(e);
                  });
              var o = xa.getEventName(
                "resize.bootstrap-table",
                this.$el.attr("id")
              );
              i.default(window).off(o),
                !this.options.showHeader || this.options.cardView
                  ...
                  : (this.$header.show(),
                    ...
                    this.getCaret(),
                    i.default(window).on(o, function () {
                      return t.resetView();
                    })),
          ...
          },
          {
            ...
            value: function (t, e) {
              "append" === e
                ...
                : ((t = t || xa.deepCopy(this.options.data)),
                  (this.options.data = Array.isArray(t)
                    ? t
                    : t[this.options.dataField])),
                (this.data = Qo(this.options.data)),
                this.options.sortReset && (this.unsortedData = Qo(this.data)),
          ...
          },
          {
            ...
            value: function () {
              ...
              -1 !== n
                ? (this.options.sortStable &&
                  ...
                  this.options.customSort
                    ...
                    : this.data.sort(function (o, a) {
                        ...
                        var s = xa.getItemField(o, e, t.options.escape),
                          r = xa.getItemField(a, e, t.options.escape),
                          l = xa.calculateObjectValue(
                            t.header,
                            t.header.sorters[n],
                            [s, r, o, a]
                          );
                ...
                : this.options.sortReset && (this.data = Qo(this.unsortedData));
            },
          },
          {
            key: "onSort",
            value: function (t) {
              ...
              if (
                ...
                o.add(a).data("order", this.options.sortOrder),
                this.getCaret(),
                "server" === this.options.sidePagination &&
          ...
          },
          {
            ...
            value: function () {
              ...
              this.$toolbar.find(".bs-bars").children().length &&
                i.default("body").append(i.default(n.toolbar)),
                this.$toolbar.html(""),
                ("string" != typeof n.toolbar && "object" !== Go(n.toolbar)) ||
                  i
                    .default(
                      xa.sprintf(
                    ...
                    html: function () {
                      ...
                      if (
                        (t.push(
                          '<div class="keep-open '
                            .concat(
                              e.constants.classes.buttonsDropdown,
                              '" title="'
                            )
                            .concat(
                              n.formatColumns(),
                            ...
                            .concat(
                              e.constants.buttonsClass,
                              ' dropdown-toggle" type="button" '
                            )
                            .concat(
                              e.constants.dataToggle,
                            ...
                            .concat(
                              e.constants.html.dropdownCaret,
                              "\n            </button>\n            "
                            )
                        ...
                        n.showColumnsSearch &&
                          (t.push(
                            xa.sprintf(
                              e.constants.html.toolbarDropdownItem,
                              xa.sprintf(
                                '<input type="text" class="%s" name="columnsSearch" placeholder="%s" autocomplete="off">',
                                e.constants.classes.input,
                                n.formatSearch()
                              )
                            )
                          ),
                          t.push(e.constants.html.toolbarDropdownSeparator)),
                        n.showColumnsToggleAll)
                      ) {
                        var i =
                          e.getVisibleColumns().length ===
                      ...
                      return (
                        ...
                        e.columns.forEach(function (i, a) {
                          if (
                            !e.isSelectionColumn(i) &&
                            (!n.cardView || i.cardVisible)
                          ) {
                            var r = i.visible ? ' checked="checked"' : "",
                              l =
                                o <= n.minimumCountColumns && r
                                  ? ' disabled="disabled"'
                                  : "";
                            i.switchable &&
                              (t.push(
                        ...
                        t.push(e.constants.html.toolbarDropdown[1], "</div>"),
                        t.join("")
                      );
                    },
                  },
              ...
              for (
                var r = {}, l = 0, c = Object.entries(this.buttons);
                l < c.length;
                l++
              ) {
                var h = Jo(c[l], 2),
                ...
                if (d.hasOwnProperty("html"))
                  "function" == typeof d.html
                    ? (f = d.html())
                    : "string" == typeof d.html && (f = d.html);
                else {
                  if (
                    ((f = '<button class="'
                      .concat(
                      ...
                      .concat(u, '"')),
                    d.hasOwnProperty("attributes"))
                  )
                    for (
                      var p = 0, g = Object.entries(d.attributes);
                      p < g.length;
                      p++
                    ) {
                      var v = Jo(g[p], 2),
                ...
                var y = "show"
                    ...
                    .concat(u.substring(1)),
                  w = n[y];
                !(
                  !d.hasOwnProperty("render") ||
                  (d.hasOwnProperty("render") && d.render)
                ) ||
                  (void 0 !== w && !0 !== w) ||
                  (n[y] = !0),
                  n.buttonsOrder.includes(u) || n.buttonsOrder.push(u);
              }
              var S,
                x = ea(n.buttonsOrder);
              try {
                for (x.s(); !(S = x.n()).done; ) {
                  ...
                  n[
                    "show"
                      .concat(k.charAt(0).toUpperCase())
                      .concat(k.substring(1))
                  ] && o.push(r[k]);
                }
              } catch (t) {
                x.e(t);
              ...
              for (
                var O = 0, C = Object.entries(this.buttons);
                O < C.length;
                O++
              ) {
                var T = Jo(C[O], 2),
              ...
              if (n.showColumns) {
                var R = (t = this.$toolbar.find(".keep-open")).find(
                    'input[type="checkbox"]:not(".toggle-all")'
                  ),
                  j = t.find('input[type="checkbox"].toggle-all');
                if (
                  ...
                  R.off("click").on("click", function (t) {
                    var n = t.currentTarget,
                      o = i.default(n);
                    e._toggleColumn(o.val(), o.prop("checked"), !1),
                      e.trigger(
                        "column-switch",
                        o.data("field"),
                        o.prop("checked")
                  ...
                  j.off("click").on("click", function (t) {
                    var n = t.currentTarget;
                    e._toggleAllColumns(i.default(n).prop("checked"));
                  }),
                  n.showColumnsSearch)
                ) {
                  var _ = t.find('[name="columnsSearch"]'),
                    N = t.find(".dropdown-item-marker");
                  _.on("keyup paste change", function (t) {
              ...
              if (
                ...
                if (n.showSearchButton || n.showSearchClearButton) {
                  var H =
                    (n.showSearchButton ? D : "") +
                    (n.showSearchClearButton ? V : "");
                  L = n.search
                    ? xa.sprintf(this.constants.html.inputGroup, B, H)
                    : H;
                }
                o.push(
                  xa.sprintf(
                ...
                n.showSearchButton
                  ? (this.$toolbar
                      ...
                      .on("click", function () {
                        clearTimeout(a),
                          (a = setTimeout(function () {
                            e.onSearch({ currentTarget: M });
                          }, n.searchTimeOut));
                      }),
                    n.searchOnEnterKey && F(M))
                  : F(M),
            ...
            value: function () {
              ...
              if (void 0 !== e && i.default(e).length && o) {
                ...
                if (
                  ...
                  return;
                (e === xa.getSearchInput(this)[0] ||
                  i.default(e).hasClass("search-input")) &&
                  ((this.searchText = a), (this.options.searchText = a));
              }
            ...
            value: function () {
              ...
              if (
                ...
                if (this.options.customSearch)
                  return (
                    (this.data = xa.calculateObjectValue(
                      this.options,
                      this.options.customSearch,
                      [this.options.data, this.searchText, this.filterColumns]
                    )),
                    void (
                      this.options.sortReset &&
                      (this.unsortedData = Qo(this.data))
                    )
                  );
                var e =
                    this.searchText &&
                    (this.fromHtml
                      ? xa.escapeHTML(this.searchText)
                      : this.searchText
                    ).toLowerCase(),
                  i = xa.isEmptyObject(this.filterColumns)
                    ? null
                    : this.filterColumns;
                    ...
                    (this.data = i
                      ? this.options.data.filter(function (e) {
                          ...
                          if ("and" === n) {
                            for (var o in i)
                              if (
                                (Array.isArray(i[o]) && !i[o].includes(e[o])) ||
                                (!Array.isArray(i[o]) && e[o] !== i[o])
                              )
                                return !1;
                          } else if ("or" === n) {
                            var a = !1;
                      ...
                      for (var a = 0; a < t.header.fields.length; a++)
                        if (
                          ...
                          (!t.options.visibleSearch ||
                            -1 !== n.indexOf(t.header.fields[a]))
                        ) {
                          var s = xa.isNumeric(t.header.fields[a])
                              ? parseInt(t.header.fields[a], 10)
                              : t.header.fields[a],
                            r = t.columns[t.fieldsColumnsIndex[s]],
                            l = void 0;
                          if ("string" == typeof s) {
                            l = i;
                            for (var c = s.split("."), h = 0; h < c.length; h++)
                              null !== l[c[h]] && (l = l[c[h]]);
                          } else l = i[s];
                          if (
                            (t.options.searchAccentNeutralise &&
                              (l = xa.normalizeAccent(l)),
                            r &&
                              r.searchFormatter &&
                              (l = xa.calculateObjectValue(
                                r,
                                t.header.formatters[a],
                                [l, i, o, r.field],
                                l
                              )),
            ...
            value: function () {
              ...
              if (e.pagination) {
                ...
                if (
                  ...
                  var f = this.paginationParts.includes("pageInfoShort")
                  ...
                  d.forEach(function (i, n) {
                    ...
                    (!e.smartDisplay ||
                      ...
                      ((o = h
                        ...
                        : ""),
                      p.push(
                        xa.sprintf(t.constants.html.pageDropdownItem, o, i)
                      ));
                  }),
                    p.push(
                ...
                if (
                  ...
                  c.push(
                    ...
                    xa.sprintf(
                      ...
                      xa.sprintf(" pagination-%s", e.iconSize)
                    ),
                    xa.sprintf(
                ...
                this.$pagination.last().find(".page-list > span").addClass(y),
                  e.onlyInfoPagination ||
                    ...
                    (s = this.$pagination.find(".page-pre")),
                    (r = this.$pagination.find(".page-next")),
                    (l = this.$pagination
                      .find(".page-item")
                      .not(
                    ...
                    e.paginationLoop ||
                      (1 === e.pageNumber && s.addClass("disabled"),
                      e.pageNumber === this.totalPages &&
                        r.addClass("disabled")),
          ...
          },
          {
            ...
            value: function (t) {
              (t && i.default(t.currentTarget).hasClass("disabled")) ||
          ...
          },
          {
            ...
            value: function (t) {
              if (
                (t.preventDefault(),
                this.options.pageNumber !== +i.default(t.currentTarget).text())
              )
                return (
                  (this.options.pageNumber = +i
          ...
          },
          {
            ...
            value: function (t, e, i, n) {
              var o = this,
                ...
                c = {},
                h = [];
              if (!(xa.findIndex(this.hiddenRows, t) > -1)) {
                if (
                  (s = xa.calculateObjectValue(
                    this.options,
                  ...
                  for (
                    var u = 0, d = Object.entries(s.css);
                    u < d.length;
                    u++
                  ) {
                    var f = Jo(d[u], 2),
                ...
                if (
                  ...
                  for (var v = 0, b = Object.entries(c); v < b.length; v++) {
                    var m = Jo(b[v], 2),
                      y = m[0],
                      w = m[1];
                    h.push("".concat(y, '="').concat(xa.escapeHTML(w), '"'));
                  }
                if (t._data && !xa.isEmptyObject(t._data))
                  for (
                    ...
                    l += " data-"
                      .concat(O, "='")
                      .concat("object" === Go(C) ? JSON.stringify(C) : C, "'");
                  }
                a.push(
                  "<tr",
                  xa.sprintf(" %s", h.length ? h.join(" ") : void 0),
                  xa.sprintf(' id="%s"', Array.isArray(t) ? void 0 : t._id),
                  xa.sprintf(
                    ' class="%s"',
                    s.classes || (Array.isArray(t) ? void 0 : t._class)
                  ),
                  xa.sprintf(
                    ' style="%s"',
                    Array.isArray(t) ? void 0 : t._style
                  ),
                  ' data-index="'.concat(e, '"'),
                  xa.sprintf(
                    ' data-uniqueid="%s"',
                    xa.getItemField(t, this.options.uniqueId, !1)
                  ),
                  xa.sprintf(
                    ' data-has-detail-view="%s"',
                    this.options.detailView &&
                      xa.calculateObjectValue(null, this.options.detailFilter, [
                        e,
                        t,
                      ])
                      ? "true"
                ...
                var T = "";
                return (
                  xa.hasDetailViewIcon(this.options) &&
                    ((T = "<td>"),
                    xa.calculateObjectValue(null, this.options.detailFilter, [
                      e,
                      t,
                    ...
                    (T += "</td>")),
                  T && "right" !== this.options.detailViewAlign && a.push(T),
                  this.header.fields.forEach(function (i, n) {
                    var s = "",
                      l = xa.getItemField(t, i, o.options.escape),
                      c = "",
                      h = "",
                      u = {},
                      d = "",
                    ...
                    if (
                      ((!o.fromHtml && !o.autoMergeCells) ||
                        ...
                        w.radio) &&
                      w.visible &&
                      (!o.options.cardView || w.cardVisible)
                    ) {
                      if (
                        (w.escape && (l = xa.escapeHTML(l)),
                        r.concat([o.header.styles[n]]).length &&
                          (g += "".concat(
                            r.concat([o.header.styles[n]]).join("; ")
                          )),
                        t["_".concat(i, "_style")] &&
                          (g += "".concat(t["_".concat(i, "_style")])),
                        g && (p = ' style="'.concat(g, '"')),
                        t["_".concat(i, "_id")] &&
                          (d = xa.sprintf(' id="%s"', t["_".concat(i, "_id")])),
                        t["_".concat(i, "_class")] &&
                          (f = xa.sprintf(
                            ' class="%s"',
                            t["_".concat(i, "_class")]
                        ...
                        for (
                          var S = [], x = 0, k = Object.entries(u.css);
                          x < k.length;
                          x++
                        ) {
                          var O = Jo(k[x], 2),
                      ...
                      if (
                        ...
                        if (
                          ...
                          var $ = new DOMParser().parseFromString(
                              c.toString(),
                              "text/html"
                            ).documentElement.textContent,
                            E = $.replace(A, I);
                          P = c.replace(
                            new RegExp("(>\\s*)(".concat($, ")(\\s*)"), "gm"),
                            "$1".concat(E, "$3")
                          );
                        } else P = c.toString().replace(A, I);
                        c = xa.calculateObjectValue(
                          w,
                          w.searchHighlightFormatter,
                          [c, o.searchText],
                          P
                        );
                      }
                      if (
                        t["_".concat(i, "_data")] &&
                        !xa.isEmptyObject(t["_".concat(i, "_data")])
                      )
                        for (
                          var R = 0,
                            j = Object.entries(t["_".concat(i, "_data")]);
                          R < j.length;
                          R++
                        ) {
                          var _ = Jo(j[R], 2),
                            ...
                            F = _[1];
                          if ("index" === N) return;
                          v += " data-".concat(N, '="').concat(F, '"');
                        }
                      if (w.checkbox || w.radio) {
                        (h = w.checkbox ? "checkbox" : h),
                          (h = w.radio ? "radio" : h);
                        var D = w.class || "",
                          V =
                            xa.isObject(c) && c.hasOwnProperty("checked")
                              ? c.checked
                              : (!0 === c || l) && !1 !== c,
                          B = !w.checkboxEnabled || (c && c.disabled);
                        (s = [
                          o.options.cardView
                            ? '<div class="card-view '.concat(D, '">')
                          ...
                          '<label>\n            <input\n            data-index="'
                            ...
                            .concat(h, '"\n            ')
                            .concat(
                              xa.sprintf('value="%s"', t[o.options.idField]),
                              "\n            "
                            )
                            .concat(
                              xa.sprintf(
                        ...
                        var L = o.options.showHeader
                          ? '<span class="card-view-title '
                              .concat(u.classes, '"')
                              .concat(p, ">")
                              .concat(xa.getFieldTitle(o.columns, i), "</span>")
                          : "";
                        (s = '<div class="card-view">'
                          .concat(L, '<span class="card-view-value ')
                          .concat(u.classes, '"')
                          .concat(p, ">")
                          .concat(c, "</span></div>")),
                          o.options.smartDisplay &&
                            "" === c &&
                            (s = '<div class="card-view"></div>');
                      } else
                        s = "<td"
                          .concat(d)
                          .concat(f)
                  ...
                  T && "right" === this.options.detailViewAlign && a.push(T),
                  this.options.cardView && a.push("</div></td>"),
                  a.push("</tr>"),
                  a.join("")
                );
              }
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var o = [],
                a = i.default(document.createDocumentFragment()),
                s = !1;
              this.autoMergeCells = xa.checkAutoMergeCells(
                n.slice(this.pageFrom - 1, this.pageTo)
              );
              for (var r = this.pageFrom - 1; r < this.pageTo; r++) {
                var l = n[r],
                  c = this.initRow(l, r, n, a);
                (s = s || !!c),
                  c &&
                    "string" == typeof c &&
                    (this.options.virtualScroll ? o.push(c) : a.append(c));
              }
              s
                ? this.options.virtualScroll
                  ? (this.virtualScroll && this.virtualScroll.destroy(),
                    (this.virtualScroll = new ka({
                      rows: o,
                      fixedScroll: t,
                    ...
                    '<tr class="no-records-found">'.concat(
                      xa.sprintf(
                        ...
                        this.getVisibleFields().length +
                          xa.getDetailViewIndexOffset(this.options),
              ...
              this.$body
                ...
                .on("click dblclick", function (e) {
                  var n = i.default(e.currentTarget),
                    ...
                    s = i.default(e.target).parents(".card-view"),
                    r = o.data("index"),
                    l = t.data[r],
                    c = t.options.cardView ? a.index(s) : n[0].cellIndex,
                    h = t.getVisibleFields()[
                      c - xa.getDetailViewIndexOffset(t.options)
                    ],
                    u = t.columns[t.fieldsColumnsIndex[h]],
                    d = xa.getItemField(l, h, t.options.escape);
                  if (!n.find(".detail-icon").length) {
                    if (
                      (t.trigger(
                        "click" === e.type ? "click-cell" : "dbl-click-cell",
                        h,
                        d,
                        l,
                        n
                      ...
                      t.trigger(
                        "click" === e.type ? "click-row" : "dbl-click-row",
                        l,
                        o,
                        h
                      ),
                      "click" === e.type &&
                        t.options.clickToSelect &&
                        u.clickToSelect &&
                        !xa.calculateObjectValue(
                          t.options,
                          t.options.ignoreClickToSelectOn,
                          [e.target]
                        ))
                    ) {
                      var f = o.find(
                        xa.sprintf('[name="%s"]', t.options.selectItemName)
                      );
                      f.length && f[0].click();
                    }
                    "click" === e.type &&
                      t.options.detailViewByClick &&
                      t.toggleDetailView(
                        r,
                        t.header.detailFormatters[t.fieldsColumnsIndex[h]]
                      );
                  }
                })
                .off("mousedown")
                .on("mousedown", function (e) {
                  (t.multipleSelectRowCtrlKey = e.ctrlKey || e.metaKey),
                    (t.multipleSelectRowShiftKey = e.shiftKey);
                }),
                this.$body
                ...
                (this.$selectItem = this.$body.find(
                  xa.sprintf('[name="%s"]', this.options.selectItemName)
                )),
                ...
                this.header.events.forEach(function (e, n) {
                  ...
                  if (o) {
                    "string" == typeof o &&
                      (o = xa.calculateObjectValue(null, o));
                    var a = t.header.fields[n],
                      s = t.getVisibleFields().indexOf(a);
                    if (-1 !== s) {
                      s += xa.getDetailViewIndexOffset(t.options);
                      var r = function (e) {
          ...
          },
          {
            ...
            value: function (t, e, n) {
              ...
              if (
                (this.header.sortNames[s] &&
                  (r.sortName = this.header.sortNames[s]),
                this.options.pagination &&
                  "server" === this.options.sidePagination &&
                  ((r.pageSize =
                ...
                if (
                  (xa.isEmptyObject(this.filterColumnsPartial) ||
                    (r.filter = JSON.stringify(
                      this.filterColumnsPartial,
                      null
                    )),
                  i.default.extend(r, e || {}),
                  !1 !==
                    (a = xa.calculateObjectValue(
                      this.options,
                  ...
                  var u = i.default.extend(
                    {},
                    xa.calculateObjectValue(null, this.options.ajaxOptions),
                    {
                      ...
                      success: function (e, i, n) {
                        ...
                        o.load(a),
                          o.trigger("load-success", a, n && n.status, n),
                          t || o.hideLoading(),
                          "server" === o.options.sidePagination &&
                            a[o.options.totalField] > 0 &&
                            !a[o.options.dataField].length &&
                            o.updatePagination();
                      },
                      error: function (e) {
                        var i = [];
                        "server" === o.options.sidePagination &&
                          ...
                          o.load(i),
                          o.trigger("load-error", e && e.status, e),
                          t || o.$tableLoading.hide();
                      },
                    }
                  );
                  return (
            ...
            value: function () {
              ...
              this.$header.find("th").each(function (e, n) {
                i.default(n)
                  ...
                  .addClass(
                    i.default(n).data("field") === t.options.sortName
                      ? t.options.sortOrder
                      : "both"
                  );
              });
            ...
            value: function () {
              ...
              this.$selectAll.add(this.$selectAll_).prop("checked", t),
                this.$selectItem.each(function (t, e) {
                  i.default(e)
                    .closest("tr")
                    [i.default(e).prop("checked") ? "addClass" : "removeClass"](
                      "selected"
                    );
                });
            },
          },
          {
            ...
            value: function () {
              ...
              this.$selectItem.each(function (e, n) {
                t.data[i.default(n).data("index")][
                  t.header.stateField
                ] = i.default(n).prop("checked");
              });
            },
          },
          {
          ...
          },
          {
            ...
            value: function (e) {
              for (
                ...
                r[l - 1] = arguments[l];
              (n = this.options)[t.EVENTS[a]].apply(n, [].concat(r, [this])),
                this.$el.trigger(i.default.Event(a, { sender: this }), r),
                (o = this.options).onAll.apply(
                  o,
                  [a].concat([].concat(r, [this]))
                ),
                this.$el.trigger(
                  i.default.Event("all.bs.table", { sender: this }),
                  [a, r]
                );
            },
          },
              ...
              if (this.$el.is(":hidden"))
                ...
                var e = this.$tableBody.get(0),
                  n =
                    ...
                    e.scrollHeight > e.clientHeight + this.$header.outerHeight()
                      ? xa.getScrollBarWidth()
                      : 0;
                ...
                u.find("> *").each(function (e, n) {
                  var o = i.default(n);
                  if (
                    xa.hasDetailViewIcon(t.options) &&
                    ((0 === e && "right" !== t.options.detailViewAlign) ||
                    ...
                    var r = e - xa.getDetailViewIndexOffset(t.options),
                      l = t.$header_.find(
                        xa.sprintf('th[data-field="%s"]', c[r])
                      );
                ...
                try {
                  for (o.s(); !(n = o.n()).done; ) {
                    var a,
                      ...
                      l = [],
                      c = {},
                      h = xa.sprintf(' class="%s"', r.class);
                    if (
                      !(
                        !r.visible ||
                        (this.footerData &&
                          this.footerData.length > 0 &&
                          !(r.field in this.footerData[0]))
                      )
                    ) {
                      ...
                      if (
                        ((a = xa.sprintf(
                          "text-align: %s; ",
                          r.falign ? r.falign : r.align
                        )),
                        (s = xa.sprintf("vertical-align: %s; ", r.valign)),
                        (c = xa.calculateObjectValue(
                          null,
                        ...
                        for (
                          var u = 0, d = Object.entries(c.css);
                          u < d.length;
                          u++
                        ) {
                          var f = Jo(d[u], 2),
                            p = f[0],
                            g = f[1];
                          l.push("".concat(p, ": ").concat(g));
                        }
                      c &&
                        c.classes &&
                        (h = xa.sprintf(
                          ' class="%s"',
                          r.class ? [r.class, c.classes].join(" ") : c.classes
                        )),
                        e.push(
                          "<th",
                          h,
                      ...
                      this.footerData &&
                        this.footerData.length > 0 &&
                        (v =
                          this.footerData[0]["_".concat(r.field, "_colspan")] ||
                          0),
                        v && e.push(' colspan="'.concat(v, '" ')),
                        e.push(">"),
                        e.push('<div class="th-inner">');
                      var b = "";
                      this.footerData &&
                        this.footerData.length > 0 &&
                        (b = this.footerData[0][r.field] || ""),
                        e.push(
                          xa.calculateObjectValue(
                            r,
                            r.footerFormatter,
            ...
            value: function () {
              ...
              if (this.$el.is(":hidden"))
                ...
                for (
                  ...
                  a.length && a.find('>td[colspan]:not([colspan="1"])').length;
                ...
                a.find("> *").each(function (e, n) {
                  ...
                  if (
                    xa.hasDetailViewIcon(t.options) &&
                    ((0 === e && "left" === t.options.detailViewAlign) ||
                      (e === s - 1 && "right" === t.options.detailViewAlign))
                  ) {
                    var r = o.filter(".detail"),
                      l = r.innerWidth() - r.find(".fht-cell").width();
          ...
          },
          {
            key: "refreshOptions",
            value: function (t) {
              xa.compareObjects(this.options, t, !0) ||
                ((this.options = i.default.extend(this.options, t)),
            ...
            value: function (t) {
              ...
              if (
                ((!(
                  ...
                  xa.isEmptyObject(this.filterColumns) &&
                  xa.isEmptyObject(this.filterColumnsPartial)) ||
                  (t && t.unfiltered) ||
                  (i = this.data),
                t &&
                  ...
                  i.forEach(function (t) {
                    for (var i = 0, n = Object.entries(t); i < n.length; i++) {
                      var o = Jo(n[i], 2),
                        a = o[0],
                        s = o[1],
                        r = e.columns[e.fieldsColumnsIndex[a]];
                      if (!r) return;
                      t[a] = xa.calculateObjectValue(
                        r,
                        e.header.formatters[r.fieldIndex],
                        [s, t, t.index, r.field],
                        s
                      );
                    }
          ...
          },
          {
            ...
            value: function () {
              var t = this;
              return (this.options.maintainMetaData
                ? this.options.data
                : this.data
              ).filter(function (e) {
          ...
          },
          {
            ...
            value: function (t) {
              for (var e = 0, i = this.options.data.length - 1; i >= 0; i--) {
                ...
                (n.hasOwnProperty(t.field) || "$index" === t.field) &&
                  ((!n.hasOwnProperty(t.field) &&
                    "$index" === t.field &&
                    t.values.includes(i)) ||
                    t.values.includes(n[t.field])) &&
                ...
                for (n.s(); !(e = n.n()).done; ) {
                  ...
                  o.hasOwnProperty("index") &&
                    ...
                    (o.hasOwnProperty("replace") && o.replace
                      ? (this.options.data[o.index] = o.row)
                      : i.default.extend(this.options.data[o.index], o.row));
                }
              } catch (t) {
                n.e(t);
              } finally {
                  ...
                  if (o.hasOwnProperty("id") && o.hasOwnProperty("row")) {
                    ...
                    -1 !== a &&
                      (o.hasOwnProperty("replace") && o.replace
                        ...
                        : i.default.extend(this.options.data[a], o.row));
                  }
                }
              } catch (t) {
                n.e(t);
            ...
            value: function (t) {
              ...
              (Array.isArray(t) ? t : [t]).forEach(function (t) {
                var i = t.id,
                  n = t.field,
                  o = t.value,
                  a = e.options.data.indexOf(e.getRowByUniqueId(i));
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if (
                ...
                var n = xa.findIndex(this.hiddenRows, i);
                e || -1 !== n
            ...
            value: function (t, e, i) {
              if (
                ...
                var n = this.$toolbar
                  ...
                  .prop("disabled", !1);
                i && n.filter(xa.sprintf('[value="%s"]', t)).prop("checked", e),
          ...
          },
          {
            ...
            value: function (t) {
              var e,
                n = this,
                o = ea(this.columns.slice().reverse());
              try {
                for (o.s(); !(e = o.n()).done; ) {
                  var a = e.value;
                  if (a.switchable) {
          ...
          },
          {
            ...
            value: function (t) {
              var e,
                ...
                s = t.colspan || 1,
                r = this.$body.find(">tr");
              o += xa.getDetailViewIndexOffset(this.options);
              var l = r.eq(n).find(">td").eq(o);
              if (!(n < 0 || o < 0 || n >= this.data.length)) {
                for (e = n; e < n + a; e++)
                  for (i = o; i < o + s; i++) r.eq(e).find(">td").eq(i).hide();
              ...
              if (
                ...
                if (
                  ...
                  for (
                    ...
                    (this.data[c][this.header.stateField] = !0),
                      this.$selectItem
                        .filter('[data-index="'.concat(c, '"]'))
                        .prop("checked", !0);
              ...
              if (e.hasOwnProperty("field") && e.hasOwnProperty("values")) {
                ...
                this.data.forEach(function (o, a) {
                  ...
                  if (e.values.includes(o[e.field])) {
                    var s = i.$selectItem
                      .filter(":enabled")
                      .filter(xa.sprintf('[data-index="%s"]', a));
                    if (
                      !(s = t ? s.not(":checked") : s.filter(":checked")).length
                    )
                      return;
                    s.prop("checked", t),
                      (o[i.header.stateField] = t),
                      n.push(o),
                      i.trigger(t ? "check" : "uncheck", o, s);
                  }
                }),
                  this.updateSelected(),
          ...
          },
          {
            ...
            value: function () {
              this.$el.insertBefore(this.$container),
                i.default(this.options.toolbar).insertBefore(this.$el),
              ...
              if (
                ...
                if (
                  ...
                  this.$tableBody[0].scrollWidth -
                    ...
                    (r -= xa.getScrollBarWidth()),
                    this.$tableBorder.css(
                      "width",
                      "".concat(a.outerWidth(), "px")
                    ),
                    this.$tableBorder.css("height", "".concat(r, "px"));
                }
              }
              this.options.cardView
          ...
          },
          {
            key: "filterBy",
            value: function (t, e) {
              (this.filterOptions = xa.isEmptyObject(e)
                ? this.options.filterOptions
                : i.default.extend(this.options.filterOptions, e)),
                (this.filterColumns = xa.isEmptyObject(t) ? {} : t),
                (this.options.pageNumber = 1),
                this.initSearch(),
                this.updatePagination();
            },
          },
          {
            ...
            value: function (t) {
              ...
              "object" === Go(t)
                ? (e = Object.assign(e, t))
                : "string" == typeof t && "bottom" === t
                ? (e.value = this.$tableBody[0].scrollHeight)
              ...
              "rows" === e.unit &&
                ((n = 0),
                this.$body
                  .find("> tr:lt(".concat(e.value, ")"))
                  .each(function (t, e) {
                    n += i.default(e).outerHeight(!0);
                  })),
          ...
          },
          {
            ...
            value: function (t, e) {
              this.$body
                .find(xa.sprintf('> tr[data-index="%s"]', t))
                .next()
                .is("tr.detail-view")
                ? this.collapseRow(t)
                : this.expandRow(t, e),
          ...
          },
          {
            ...
            value: function (t, e) {
              var i = this.data[t],
                n = this.$body.find(
                  xa.sprintf('> tr[data-index="%s"][data-has-detail-view]', t)
                );
              if (!n.next().is("tr.detail-view")) {
                ...
                var o = n.next().find("td"),
                  ...
                  s = xa.calculateObjectValue(this.options, a, [t, i, o], "");
                1 === o.length && o.append(s),
          ...
          },
          {
            ...
            value: function (t) {
              t.hasOwnProperty("field") &&
                ...
                ((this.columns[this.fieldsColumnsIndex[t.field]].title = this
                  .options.escape
                  ? xa.escapeHTML(t.title)
                  : t.title),
                this.columns[this.fieldsColumnsIndex[t.field]].visible &&
                  (this.$header.find("th[data-field]").each(function (e, n) {
                    if (i.default(n).data("field") === t.field)
                      return (
                        i
                          .default(i.default(n).find(".th-inner")[0])
                          .text(t.title),
                        !1
                      );
                  }),
  ...
  return (
    (Oa.VERSION = ca.VERSION),
    (Oa.DEFAULTS = ca.DEFAULTS),
    (Oa.LOCALES = ca.LOCALES),
    (Oa.COLUMN_DEFAULTS = ca.COLUMN_DEFAULTS),
    (Oa.METHODS = ca.METHODS),
    (Oa.EVENTS = ca.EVENTS),
    (i.default.BootstrapTable = Oa),
    (i.default.fn.bootstrapTable = function (t) {
      for (
      ...
      return (
        this.each(function (e, o) {
          var s = i.default(o).data("bootstrap.table"),
            r = i.default.extend(
              {},
              Oa.DEFAULTS,
              i.default(o).data(),
          ...
          if ("string" == typeof t) {
            var l;
            if (!ca.METHODS.includes(t))
              throw new Error("Unknown method: ".concat(t));
            if (!s) return;
            (a = (l = s)[t].apply(l, n)),
              "destroy" === t && i.default(o).removeData("bootstrap.table");
          }
          s ||
            ((s = new i.default.BootstrapTable(o, r)),
            i.default(o).data("bootstrap.table", s),
            s.init());
        }),
        void 0 === a ? this : a
      );
    }),
    (i.default.fn.bootstrapTable.Constructor = Oa),
    (i.default.fn.bootstrapTable.theme = ca.THEME),
    (i.default.fn.bootstrapTable.VERSION = ca.VERSION),
    (i.default.fn.bootstrapTable.defaults = Oa.DEFAULTS),
    (i.default.fn.bootstrapTable.columnDefaults = Oa.COLUMN_DEFAULTS),
    (i.default.fn.bootstrapTable.events = Oa.EVENTS),
    (i.default.fn.bootstrapTable.locales = Oa.LOCALES),
    (i.default.fn.bootstrapTable.methods = Oa.METHODS),
    (i.default.fn.bootstrapTable.utils = xa),
    i.default(function () {
